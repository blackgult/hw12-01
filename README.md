...
Оклад (
- идентификатор, первичный ключ, serial, составной из внешних ключей: Позиция сотрудника, внешний ключ, integer + Проект на который назначен, внешний ключ, integer,
- Оклад, numeric )
